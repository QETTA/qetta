...
export const QettaLeftSidebar = memo(function QettaLeftSidebar({
  ...
  const handleSearchClick = () => {
    showToast('검색 기능 준비 중입니다 (Cmd+K)', 'info')
  }

  const handleCategoryAdd = () => {
    showToast('카테고리 추가 기능 준비 중입니다', 'info')
  }
  ...
  return (
    <aside
      className={`${
        collapsed ? 'w-16' : 'w-60'
      } hidden flex-shrink-0 flex-col border-r border-white/10 bg-zinc-900 transition-all duration-300 sm:flex`}
      role="navigation"
    ...
    >
        ...
        <div className="flex items-center gap-3">
          {!collapsed ? (
            <div className="flex flex-col">
              <span className="text-base font-semibold tracking-tight text-white">QETTA</span>
              <span className="text-[10px] font-medium text-zinc-500">Documentation Platform</span>
            </div>
          ) : (
      ...
      <div className="px-3 py-3">
        <button
          ...
          className="flex w-full items-center gap-2 rounded-lg bg-white/5 px-3 py-2 text-zinc-400 ring-1 ring-white/10 transition-colors hover:bg-white/10 focus:ring-2 focus:ring-white/30 focus:outline-none"
        ...
        >
          ...
          {!collapsed && (
            <>
              ...
              <kbd className="rounded border border-white/10 bg-zinc-800 px-1.5 py-0.5 text-[10px] font-medium text-zinc-500">
                Cmd+K
              </kbd>
            </>
          )}
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-2">
          ...
          {navItems.map((item) => (
            <li key={item.id}>
              <Link
                ...
                className={`flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium transition-all focus:ring-2 focus:ring-white/30 focus:outline-none ${
                  activeTab === item.id
        ...
        <ul className="mt-4 space-y-1 border-t border-white/5 pt-4">
          <li>
            <button
              aria-label="Archive"
              className="flex w-full items-center gap-3 rounded-lg px-3 py-2 text-sm text-zinc-500 transition-colors hover:bg-white/5 hover:text-zinc-300"
            >
              <svg
                className="h-5 w-5"
                fill="none"
      ...
      {!collapsed && (
        <div className="border-t border-white/5 px-3 py-4">
          ...
          <div className="mb-3 rounded-lg bg-zinc-800/50 p-3 ring-1 ring-white/10">
          ...
          <ul className="space-y-1">
            {ENGINE_PRESETS.map((engine) => (
              <li key={engine.id}>
                <button className="flex w-full items-center justify-between gap-2 rounded-lg px-3 py-1.5 text-sm text-zinc-400 transition-colors hover:bg-white/5 hover:text-white">
                  <div className="flex items-center gap-2">
                    <span className={`h-2 w-2 rounded-full ${engineColors[engine.color]}`}></span>
        ...
        <div className="border-t border-white/5 px-3 py-4">
          <div className="mb-2 flex items-center justify-between">
            ...
            <button
              ...
              className="rounded text-zinc-500 transition-colors hover:text-white focus:ring-2 focus:ring-white/30 focus:outline-none"
          ...
          <ul className="space-y-0.5">
            {documentBuckets.map((bucket) => (
              <li key={bucket.id}>
                <button className="flex w-full items-center gap-2 rounded-lg px-3 py-1.5 text-sm text-zinc-400 transition-colors hover:bg-white/5 hover:text-white">
      ...
      <div className="space-y-2 border-t border-white/5 px-3 py-3">
        ...
        <Link
          href="/"
          className="flex w-full items-center justify-center gap-2 rounded-lg px-3 py-2 text-zinc-400 transition-colors hover:bg-white/5 hover:text-white focus:ring-2 focus:ring-white/30 focus:outline-none"
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg px-3 py-2 text-zinc-500 transition-colors hover:bg-white/5 hover:text-zinc-300 focus:ring-2 focus:ring-white/30 focus:outline-none"
