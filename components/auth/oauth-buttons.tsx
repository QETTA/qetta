 ...
 *
 * Reusable OAuth login buttons for Google and GitHub.
 * Extracted from login-form and signup-form to reduce duplication.
 *
 * @module auth/oauth-buttons
 */
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className={clsx(
          'w-full h-11 rounded-lg text-sm font-medium',
          'bg-[#2F2F2F] text-white ring-1 ring-white/10',
          'hover:bg-[#3F3F3F]',
          'focus:outline-none focus:ring-2 focus:ring-white/20 focus:ring-offset-2 focus:ring-offset-zinc-950',
          'disabled:opacity-50 disabled:cursor-not-allowed',
          'transition-all duration-200',
