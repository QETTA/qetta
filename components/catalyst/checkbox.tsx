...
const base = [
  ...
  // Focus ring
  'group-data-focus:outline-2 group-data-focus:outline-offset-2 group-data-focus:outline-white/30',
  // Disabled state
...
const colors = {
  ...
  violet:
    '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-zinc-500)] [--checkbox-checked-border:var(--color-zinc-600)]/90',
  purple:
